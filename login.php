...
<center>
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" id="pass" onkeyup="valid();" name="pass" required
    >
		<div class="text">
         </div>  
    </div>
  ...
  <div class="text-center my-4">
      ...
      <div class="link login-link text-center">
           <a href="reset1.php">Forget Password</a>
      </div>
...
if(isset($_POST['submit'])){
 ...
 echo "<script>alert('Your Account has Login! $email'); window.location = 'index1.php'</script>";
}
}else{
